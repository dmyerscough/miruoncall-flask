...
def test_get_incidents(mock_query_resp):
    """
...
def test_get_teams(mock_query_resp):
    ...
    assert isinstance(team, types.GeneratorType)
    next(team)
...
def test_get_schedules(mock_query_resp):
    ...
    assert isinstance(schedules, types.GeneratorType)
...
def test_query(mock_session, mock_request):
    """
...
@patch('oncall.utils.pagerduty.Request')
@patch('oncall.utils.pagerduty.Session')
def test_query_failure(mock_session, mock_request):
    """
