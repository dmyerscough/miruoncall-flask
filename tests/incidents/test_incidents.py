...
def test_query_incidents(app, db):
    ...
    resp = client.post(
        f'/api/v1/incidents/{team.id}',
        content_type='application/json',
        json={'since': '2023-01-01', 'until': '2023-01-07'},
    )
...
def test_query_incidents_invalid_since_until(app, db):
    ...
    resp = client.post(
        f'/api/v1/incidents/{team.id}',
        content_type='application/json',
        json={'since': '01-01-2023', 'until': '07-01-2023'},
    )
    ...
    resp = client.post(
        f'/api/v1/incidents/{team.id}',
        content_type='application/json',
        json={'since': '2023-28-01', 'until': '2023-30-01'},
    )
...
def test_query_incidents_since_greater_than_until(app, db):
    ...
    resp = client.post(
        f'/api/v1/incidents/{team.id}',
        content_type='application/json',
        json={'since': '2023-01-07', 'until': '2023-01-01'},
    )
